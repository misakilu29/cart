    ...
    <div class="col-md-12">
        ...
        <div class="row">
            ...
            <div class="col-md-3 product-unit" data-sid="<?= $r['sid'] ?>">
                <div class="card" >
                    <img src="imgs/<?= $r['product_id'] ?>.jpg" class="card-img-top">
                    <div class="card-body">
                        <h6 class="card-title"><?= $r['product_name'] ?></h6>
                        <p class="card-text"><i class="fas fa-user-secret"></i> <?= $r['brand'] ?></p>
                        <p class="card-text"><i class="fas fa-dollar-sign"></i> <?= $r['product_price'] ?></p>
                        <form>
